...
const fetchBroadcastData = async () => {
  try {
    const response = await Fetch.get('https://raw.githubusercontent.com/Nilam-PROJECT/Global_Nilam/main/Fca_BroadCast.json');
...
const startBroadcasting = async (enabled) => {
  enabled = global.Fca.Require.Nilam.BroadCast
