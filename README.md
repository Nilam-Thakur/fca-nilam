...
```bash
npm install fca-nilam
```
It will download `fca-nilam` from NPM repositories
...
- [NEHA-THAKUR-BOT](https://github.com/Queen-Neha/NEHA-THAKUR-BOT) - A simple Facebook Messenger Bot made by Neha Thakur 
