...
if (!fs.existsSync(process.cwd() + '/Nilam_Database') || !fs.existsSync(process.cwd() + '/Nilam_Database/RandPass.json')) {
  ...
  if (!fs.existsSync(process.cwd() + '/Nilam_Database')) {
    fs.mkdirSync(process.cwd() + '/Nilam_Database');
  }
  fs.writeFileSync(process.cwd() + '/Nilam_Database/RandPass.json', JSON.stringify(ArrPassWord, null, 2), 'utf8');
}

else {
  ArrPassWord = JSON.stringify(fs.readFileSync(process.cwd() + '/Nilam_Database/RandPass.json'));
}
